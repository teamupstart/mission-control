/**
 * What is at stake: thirteen built-in versions now open a pull request two different ways, and
 * twelve of them may be pinned by bindings on operators' machines.
 *
...
before(() => {
  assert.equal(noMistakes().versions.length, 13, "this file is written against thirteen versions");
});
