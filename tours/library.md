...
Binding attaches a published version to one session's work in one repository. The current version ships Foreman-complete as its trigger, live delivery of each repair packet into the session, and five repair rounds before it stops asking.
