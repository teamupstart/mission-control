...
- 2026-07-27 (PR #282): `ensembleClusterHeadline` is the headers' accessible name as well as their hover copy, so it states the frame-local attention and always names the run - it previously dropped both when the summary had not yet arrived, understating a badge that was already on screen.
