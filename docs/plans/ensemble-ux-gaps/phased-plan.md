...
- `membersNeedingInput` / `needsInput` / `ensembleStageWord` (Phase 1) are the ONE wire truth and vocabulary; no browser re-derivation, no second mapping. No new ensemble alert class for blocked members (5.4 rationale).
