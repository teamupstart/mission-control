...
- Snapshot capture, portable reconstruction, and rollback under checkout mutation, Git failure, database failure, digest mismatch, every prepare/promote/activate/release/discard crash window, restart reconciliation, retention, and cleanup retries.
