...
export function App(): React.JSX.Element {
  ...
  }, [visible, selectedId, selected, consoleZone, expandedId, boardOpen, renamingId, toggleExpand, bindings, layout, files.ensure, requestFilesTab, openDiff, route.page, navigate, focusConsoleRail, focusConsoleDetail]);
