...
| **Sessions** | This machine | **Harnesses**, **Worktrees**, **Repositories**, **Skills** (writes `~/`), **Standing instructions**, **Cost** (writes `~/`), **Restore** (reads and writes the owner-only state library) |
