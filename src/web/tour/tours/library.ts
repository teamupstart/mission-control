...
const STEPS: readonly Step[] = [
  {
    id: "library",
    ...tourStageContent("library", "library"),
  ...
  {
    id: "persona-library",
    ...tourStageContent("library", "persona-library"),
  ...
  {
    id: "persona-anatomy",
    ...tourStageContent("library", "persona-anatomy"),
    targets: [
  ...
  {
    id: "persona-editing",
    ...tourStageContent("library", "persona-editing"),
  ...
  {
    id: "action-library",
    ...tourStageContent("library", "action-library"),
  ...
  {
    id: "action-contract",
    ...tourStageContent("library", "action-contract"),
    targets: [
  ...
  {
    id: "command-slot",
    ...tourStageContent("library", "command-slot"),
  ...
  },
  {
    ...
    ...tourStageContent("library", "command-overrides"),
    targets: [
  ...
  {
    id: "workflow-builder",
    ...tourStageContent("library", "workflow-builder"),
  ...
  {
    id: "workflow-draft",
    ...tourStageContent("library", "workflow-draft"),
    targets: [
  ...
  },
  {
    ...
    ...tourStageContent("library", "workflow-no-mistakes"),
  ...
  {
    id: "workflow-bind",
    ...tourStageContent("library", "workflow-bind"),
  ...
  {
    id: "run-moving",
    ...tourStageContent("library", "run-moving"),
    targets: [
      {
  ...
  {
    id: "run-watched",
    ...tourStageContent("library", "run-watched"),
    targets: [
      {
  ...
  {
    id: "close",
    ...tourStageContent("library", "close"),
    targets: [],
    centered: true,
...
const CONTENT = assertTourContentStages("library", STEPS);
