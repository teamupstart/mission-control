...
/** Entry point inside the deployable Pi integration. Discovery requires a .js suffix. */
export function piExtensionPath(output = envVar("PI_EXTENSION") ?? fileURLToPath(new URL("../../dist/pi-integration/extension.js", import.meta.url))): string {
