...
| `MISSION_PI_EXTENSION` | `dist/pi-extension/index.js` | Pi extension build target and daemon artifact probe override; must end in `.js`. Building publishes atomically and does not install the extension |
