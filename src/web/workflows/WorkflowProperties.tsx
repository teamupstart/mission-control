    ...
    <aside className="workflow-properties" aria-label="Workflow properties and validation">
      {selectedNode ? (
        <section>
          ...
          {!readOnly && selectedNode.kind !== "session" && <button className="btn btn-danger" onClick={removeSelection}>Delete node</button>}
        </section>
      ) : selectedEdge ? (
        <section>
          ...
          {!readOnly && <button className="btn btn-danger" onClick={removeSelection}>Delete edge</button>}
        </section>
      ) : (
