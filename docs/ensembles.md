...
either side of a rename selects that one rename diff, while a file absent from the difference
returns an empty patch. The **statistics are complete in every answer** - a narrower request
