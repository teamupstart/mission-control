...
function seedQueue(key: string, cwd: string): void {
  upsertQueue({ noteKey: key, cwd, branch: "feature", wrapupAskedAt: null, wrapupAnswer: null, promptedGoal: null, promptedEvidence: null, promptedActivityAt: null, updatedAt: 1000 });
  const item: WorkItem = {
    id: `orphan-${++n}`,
    noteKey: key,
    seq: 0,
