...
export type TerminalExec = (
  ...
  opts?: {
    ...
    /**
     * Text for the child's stdin. Human- or model-authored payloads belong here rather
     * than in argv, whose size limits vary by operating system and terminal backend.
     * Flags, targets, and bounded key names remain command-line arguments.
     */
    input?: string;
  },
) => Promise<RunResult>;
