...
| Phase 5 — Inspector gate | Implementation-ready | Candidate prompts forbid PRs before promotion. After handoff, the Workflow's normal adopted-PR, fresh-observation, exact-head, finding, and Shipping-veto rules apply. Ensemble never adopts, polls, posts, pushes, or merges. |
